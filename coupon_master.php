						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge text-bg-primary'><a href='manage_coupon_master.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
								
								echo "<span class='badge rounded-pill text-bg-danger'><a href='?type=delete&id=".$row['id']."' class='text-white'>Delete</a></span>";
